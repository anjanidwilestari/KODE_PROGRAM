...
public class obat {
    ...
    public void save(){
        if(this.id_obat == 0){
            ...
            String query = "UPDATE obat SET "
                        ...
                        + " kategori obat = '" + this.kategori.getIdkategori() + "', "
                        + " jenis obat = '" + this.jenis_obat + "', "
                        + " merek obat = '" + this.merek_obat + "', "
                        + " harga beli obat = '" + this.harga_beli_obat + "', "
                        + " harga jual obat = '" + this.harga_jual_obat + "', "
                        + " jumlah obat = '" + this.jumlah_obat + "', "
                        + " tanggal masuk = '" + this.tanggal_masuk + "', "
    ...
    public void delete(){
        String query = "DELETE FROM obat WHERE nomor = " + this.id_obat;
        DBHelper.executeQuery(query);
    }
